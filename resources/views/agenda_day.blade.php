@push('scripts')
    ...
    <script>
        $('#salle_select').change(function () {
            ...
            $("#calenda_month").html("")
            $("#calenda_month").append("<div id=\"calendar_day\" class=\"calendar-s\"></div>");
            let calendarEl = document.getElementById('calendar_day');
        ...
        if (document.querySelectorAll('#calendar_day').length) {
    ...
    <div class="row m-3">
        ...
        <div class="col-lg-10">
            <div class="row justify-content-end">
                ...
                <div class="col-md-4">
                    <div class="btn-group">
                        <a class="btn btn-active" id="btn_day" href="{{route('agenda_day',['local'=>$salle,'date_start'=>$date_start])}}">Jour</a>
                    ...
                    <div class="card  ">
                        <div class="card-body">
                            <div id="calenda_month">
                                <div id="calendar_day" class="calendar-s"></div>
                            </div>
                        </div>
                    </div>
                </div>
